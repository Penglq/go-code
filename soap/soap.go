...
func doRoundTrip(c *Client, setHeaders func(*http.Request), in Message, out *Ret) error {
...
func (c *Client) RoundTripSoap12(action string, in Message, out *Ret) error {
	headerFunc := func(r *http.Request) {
...
type ResStruct struct {
	MerchId         string `xml:"merchId"`
	State           string `xml:"state"`
	RespId          string `xml:"respId"`
	RespCode        string `xml:"respCode"`
	RespDescription string `xml:"respDescription"`
}
